...
pts3 = ax3D.scatter(ineq_parameters[2343, 1], ineq_parameters[2343, 4], ineq_parameters[2343, 0], color='none', edgecolor=cmap2(0.1), linewidth='2',cmap=cmap, s=100)
pts4 = ax3D.scatter(ineq_parameters[3712, 1], ineq_parameters[3712, 4], ineq_parameters[3712, 0], color='none', edgecolor=cmap2(0.2), linewidth='2',cmap=cmap, s=100)
pts5 = ax3D.scatter(ineq_parameters[3888, 1], ineq_parameters[3888, 4], ineq_parameters[3888, 0], color='none', edgecolor=cmap2(0.3), linewidth='2',cmap=cmap, s=100)
pts6 = ax3D.scatter(ineq_parameters[803, 1], ineq_parameters[803, 4], ineq_parameters[803, 0], color='none', edgecolor=cmap2(0.5), linewidth='2',cmap=cmap, s=100)
